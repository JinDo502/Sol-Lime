...
const useCasesContent = [
  {
    ...
    description: <>Transfer tokens between addresses effortlessly with SOLIME &apos;s simple command interface</>,
    icon: <Icon1 />,
    link: { text: 'Try Transfer Your Token', href: '#' },
  },
  {
    title: 'Querying Token Information',
    description: <>Get crucial data about different tokens easily with SOLIME </>,
    icon: <Icon2 />,
    link: { text: 'Query a Token', href: '#' },
  },
  {
    title: 'Transaction History',
    description: <>Easily track and manage your transactions with SOLIME &apos;s transaction history feature</>,
    icon: <Icon3 />,
    link: { text: 'Start Tracking', href: '#' },
  },
  {
    title: 'Token Swapping',
    description: <>Exchange one type of token for another with SOLIME , making your experience as easy as sending a message</>,
    icon: <Icon4 />,
    link: { text: 'Try Swap Now', href: '#' },
  },
  {
    title: 'Freezing and Unfreezing Tokens',
    description: <>Have additional control over your digital assets with SOLIME &apos;s freezing and unfreezing tokens feature</>,
    icon: <Icon5 />,
    link: { text: 'Freeze a Token', href: '#' },
  },
  {
    title: 'Security Checks',
    description: <>Protect your digital assets from potential risks with SOLIME &apos;s security check feature</>,
    icon: <Icon6 />,
...

  {
    ...
    description: <>Stay updated with the latest market trends and news with SOLIME </>,
    icon: <Icon7 />,
    link: { text: 'Get Latest Updates', href: '#' },
  },
  {
    title: 'Risk Warnings',
    description: <>Get alerts about potential risks in your blockchain transactions and activities with SOLIME </>,
    icon: <Icon8 />,

...
const CTA = () => {
  return (
    <section className='py-10 px-6 container mx-auto'>
      <div className='rounded-2xl border p-6 overflow-hidden bg-[var(--card-bg)] border-[var(--primary)] border-opacity-10 flex flex-col md:flex-row md:p-8 md:gap-20'>
        <div className='text-center flex flex-col gap-4 md:w-1/2 items-cneter justify-center'>
          ...
          <Link href='#' className='h-max w-max mx-auto bg-[var(--primary)] text-[var(--background)] px-6 py-4 rounded-md'>
            Get Started Free
          </Link>
        </div>

        <div className='relative mt-10 md:w-1/2'>
          <Icon className='absolute top-0 right-0 text-[var(--primary)] w-[20%] h-auto translate-x-[-50%] translate-y-[-50%]' />
          <Image

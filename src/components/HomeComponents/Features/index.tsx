      ...
      <section className='relative overflow-hidden py-10 px-6'>
        ...
        <div className='container mx-auto'>
          ...
          <div className='text-center mt-12'>
            <a href='#' className='bg-[var(--primary)] text-[var(--background)] px-6 py-4 rounded-lg'>
              Try Now
            </a>
          </div>
        </div>
      ...
      <section className='py-10 px-6'>
        <div className='container mx-auto grid grid-cols-1 gap-8'>
          {featuresContent2?.map((item, index) => {
            return (
              <div className={`bg-[var(--card-bg)] rounded-2xl p-6 flex flex-col md:flex-row gap-8`} key={item.title}>

      ...
      <div className='container mx-auto'>
        <div className='flex flex-col gap-8 text-center md:flex-row md:py-10'>
          <div className='flex items-center gap-4 flex-col md:w-1/2 md:px-10'>
            <div className='bg-primary rounded-2xl w-16 h-16 flex items-center justify-center'>
              <BiMapAlt className='h-8 w-8 text-background' />
            </div>
            <h3 className='text-2xl md:text-3xl font-bold'>501 S Cherry St, Denver, CO 80246, USA, Denver, CO 80246, United States.</h3>
          </div>
          <div className='flex items-center gap-4 flex-col md:w-1/2 md:px-10'>
            <div className='bg-primary rounded-2xl w-16 h-16 flex items-center justify-center'>
              <AiOutlineMail className='h-8 w-8 text-background' />
            </div>
        ...
        <form className='flex flex-col gap-6 mt-16 md:w-100 md:mx-auto' id='contact-form' method='post' action='#'>
          <div className='flex flex-col gap-2'>
            ...
            <div className='flex items-center gap-2 border border-divider rounded-md p-2 overflow-hidden'>
          ...
          <div className='flex justify-start'>
            <button type='submit' className='bg-primary text-background rounded-md px-6 py-3 font-bold'>
              Send Message
            </button>
          </div>
        </form>
